  ...
  cal: function(raw_element){
    ...
    */
    function driverElement(combo_route){
      ...
      driver1[0] = combo_route[0].step1;
      driver2[0] = combo_route[0].step2;
      driver3[0] = combo_route[0].step3;

      for(var i=1; i<combo_route.length; i++){
        ...
        if( driver1.includes(current_combo[0]) == false ){
          ...
          if( driver2.includes(current_combo[1])== false ){
            ...
            if( driver3.includes(current_combo[2]) == false ){
              driver3.push(current_combo[2]);
            }
